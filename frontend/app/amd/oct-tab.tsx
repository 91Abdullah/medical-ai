...
export function AmdOctTab() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const result = await apiClient.predictAmdOct(selectedFile, onProgress)
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-6">
        ...
        <div className="medical-card p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
            About AMD OCT Analysis
          </h3>
          <div className="space-y-3 text-gray-600 dark:text-gray-300">
            <p>
              Our AI model analyzes OCT images to detect and classify Age-related Macular Degeneration
              using advanced deep learning techniques with multi-class classification.
            </p>
            <div className="grid grid-cols-1 gap-2">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="text-sm">Normal - Healthy macula</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                <span className="text-sm">Early AMD - Initial drusen formation</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-orange-500 rounded-full"></div>
                <span className="text-sm">Intermediate AMD - Geographic atrophy</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                <span className="text-sm">Late AMD - Advanced degeneration</span>
              </div>
            </div>
