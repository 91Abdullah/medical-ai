...
export function GlaucomaFundusTab() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-6">
        <div className="medical-card p-6">
          ...
          {uploadProgress && (
            <div className="mt-4">
              <div className="flex justify-between text-sm text-gray-600 dark:text-gray-400 mb-1">
                <span>Analyzing glaucoma severity...</span>
          ...
          {selectedFile && !loading && (
            ...
            >
              ...
              <span>Analyze Glaucoma Severity</span>
            </button>
          )}
          ...
          {loading && (
            <div className="mt-4">
              <LoadingSpinner
                size="md"
                text="Analyzing glaucoma severity... This may take a few moments"
                className="py-8"
              />
            </div>
          )}
        ...
        <div className="medical-card p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
            About Glaucoma Fundus Analysis
          </h3>
          <div className="space-y-3 text-gray-600 dark:text-gray-300">
            <p>
              Our AI model analyzes fundus images to detect and assess glaucoma
        ...
        {!prediction && !metadata && (
          <div className="medical-card p-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Upload a fundus image to see glaucoma severity analysis and metadata here
            </p>
          </div>
        )}
      </div>
